...
{ InputDevice device{"Gamepad"};
    ...
    device.digital("L",     virtualPorts[id].pad.a); //In Colecovision, L and R are equivalent to action buttons
    device.digital("R",     virtualPorts[id].pad.b); //In Colecovision, L and R are equivalent to action buttons
